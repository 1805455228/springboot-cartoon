package com.hins.common.config;
 ...
 *             文档URL: http://localhost:8082/doc.html
 * @version: 1.0
 */
...
public class Swagger2Config {
    ...
    public Docket createRestfulApi() {
        ...
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                //api选择器选择api的包
                .apis(RequestHandlerSelectors.basePackage("com.hins.controller"))
